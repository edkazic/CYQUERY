...
In addition the variables CYErrors and CYExecutionTime are available immediately after CY:QUERY execution.
...
Looping through records can be done eg using <CFLOOP query="queryName">
...
In addition Query of Query can be used on the record set for additional data processing using standard SQL.
